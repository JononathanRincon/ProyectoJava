...
public class RegistroJefe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar Jefe de servicio tecnico");
       ...
       String dia = Integer.toString(DateEmpleados.getCalendar().get(Calendar.DAY_OF_MONTH));
        ...
        try {
            ...
            while (rs.next()) {
                ...
                JefeTecnico MyEmpleado = new JefeTecnico(cargo, password, Identificacon, Nombre, Apellidos, telefono,
                NombreBarrio, Direccion, Fecha, correo);
                FuncionesBD funinJefe = new FuncionesBD();
                funinJefe.insercionJefe(MyEmpleado);   
            }     
