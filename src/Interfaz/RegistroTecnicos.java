 ...
 */
public class RegistroTecnicos extends javax.swing.JFrame {

    /**
     * Creates new form RegistroTecnicos
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar Tecnicos");
    ...
    private void BtnGuardar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGuardar2ActionPerformed
        ...
        try {
            ...
            ppt = Con.prepareStatement("SELECT identificacion FROM jefetecnico");
            ResultSet Rs = ppt.executeQuery();
            JOptionPane.showMessageDialog(null, 2);
            while (rs.next() && Rs.next()) {
                String cargo = rs.getString("identificacion");
                String jefe1 = Rs.getString("identificacion");
JOptionPane.showMessageDialog(null, 3 +"  "+ cargo +"   "+ jefe1);
                Tecnicos MyEmpleado = new Tecnicos(cargo, password, jefe1, Identificacon, Nombre, Apellidos, telefono,
                NombreBarrio, Direccion, Fecha, correo);
                FuncionesBD funinTecni = new FuncionesBD();
                funinTecni.inserciontECNICO(MyEmpleado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroTecnicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroTecnicos().setVisible(true);
            }
        });
    }
